...
struct Object
{
	inline int GetPropertyInt(std::string name);
	inline float GetPropertyFloat(std::string name);
	inline std::string GetPropertyString(std::string name);
...
public:
	...
	inline std::vector<Object> GetObjects(std::string name);
	inline std::vector<Object> GetAllObjects();
	inline void Draw(sf::RenderWindow &window);
	inline sf::Vector2i GetTileSize();
